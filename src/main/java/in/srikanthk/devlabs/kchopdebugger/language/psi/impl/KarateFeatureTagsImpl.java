...
public class KarateFeatureTagsImpl extends ASTWrapperPsiElement implements KarateFeatureTags {

  public KarateFeatureTagsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KarateVisitor visitor) {
    visitor.visitFeatureTags(this);
  }
