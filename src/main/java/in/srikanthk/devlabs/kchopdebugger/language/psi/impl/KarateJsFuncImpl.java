...
public class KarateJsFuncImpl extends ASTWrapperPsiElement implements KarateJsFunc {

  public KarateJsFuncImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KarateVisitor visitor) {
    visitor.visitJsFunc(this);
  }
