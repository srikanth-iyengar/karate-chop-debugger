...
public class KarateDescriptionTextImpl extends ASTWrapperPsiElement implements KarateDescriptionText {

  public KarateDescriptionTextImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KarateVisitor visitor) {
    visitor.visitDescriptionText(this);
  }
