...
public class KarateScenarioDescriptionImpl extends ASTWrapperPsiElement implements KarateScenarioDescription {

  public KarateScenarioDescriptionImpl(@NotNull ASTNode node) {
    super(node);
  }
