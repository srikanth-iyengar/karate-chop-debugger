...
public class KarateScenarioImpl extends ASTWrapperPsiElement implements KarateScenario {

  public KarateScenarioImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KarateScenarioDescription getScenarioDescription() {
    return findNotNullChildByClass(KarateScenarioDescription.class);
  }
