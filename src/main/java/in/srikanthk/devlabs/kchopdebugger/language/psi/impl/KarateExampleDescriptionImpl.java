...
public class KarateExampleDescriptionImpl extends ASTWrapperPsiElement implements KarateExampleDescription {

  public KarateExampleDescriptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KarateVisitor visitor) {
    visitor.visitExampleDescription(this);
  }
